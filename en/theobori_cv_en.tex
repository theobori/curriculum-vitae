...
\begin{resume}
  ...
  \begin{itemize}
    ...
    \item Integration of existing users and groups in Microsoft
      Entra ID, implementation of authentication with Azure, securing access with an Application Gateway
      followed by Azure Firewall, then integration of software factory
      services into Backstage.io.
    \item Creation of a Python project that produces a CLI to simplify the addition of existing projects in Backstage.io.
  \end{itemize}
